    ...
    <>
      ...
      <div className="blog-hero">
        ...
        <div className="blog-overlay-text">
          <p className="text-top animate-fade-in-up-1" style={{ marginBottom: '10px' }}>ESTILO Y CULTURA</p>
          <h1 className="blog-title animate-fade-in-up-2">BLOG</h1>
          <p className="blog-subtitle animate-fade-in-up-3">UN POCO DE MI PARA USTEDES</p>
        </div>
      </div>

      {/* Sección blog 1 */}
      <div className="blog-section">
        <img src={blog2} alt="Historia barbería" className="blog-img reveal fade-right" />
        <div className="blog-text reveal fade-left" style={{ transitionDelay: '0.2s' }}>
      ...
      {/* Sección blog 2 */}
      <div className="blog-section">
        <img src={blog3} alt="Cuidado barba" className="blog-img reveal fade-left" />
        <div className="blog-text reveal fade-right" style={{ transitionDelay: '0.2s' }}>
          <h2 className="info-title">Evita estos errores comunes y luce una barba sana y frondosa</h2>

          <p className="info-description">
            El cuidado de la barra es una parte esencial de la rutina de higiene personal para muchos hombres. Una barba bien cuidada no solo es atractiva, sino que también puede ser un símbolo de masculinidad y confianza.
          </p>
          <p className="info-description">
          ...
          <p className="info-description">
            <strong>Descuido de la piel bajo la barba:</strong> Muchos olvidad hidratar la piel debajo. Usa aceites o bálsamos para mantenerla sana y sin irritaciones.
          </p>
          <p className="info-description">
